...
class Body : ICloneable
{
    ...
    public double getResult() //Model dopasowanie
    {
        ...
        extranumbers.Add(new List<double> { Params[6].Decode(0, 1) });
        extranumbers.Add(new List<double> { Params[7].Decode(0, 1), Params[8].Decode(0, 1) });
...
class Program
{
    static void Main()
    {
        BodyManager test = new BodyManager(13,16,9,-10,10);
